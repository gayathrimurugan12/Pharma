...
<body>
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-4">
        <img src="pharam1.jpeg" class="img-fluid" alt="Pharmacy Image">
      </div>
    </div>
  </div>
  <body background="background 1.jpeg" style="background-repeat: no-repeat; background-size: cover;">
  <br>
  <br>
  <br>
  <br>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 PharmaCompany. All rights reserved. GAYATHRI 212223220024</p>
  </footer>
...
<body>
  ...
  <body background="background 1.jpeg" style="background-repeat: no-repeat; background-size: cover;"></body>
  <!-- Footer -->
  ...
  <div class="container mt-3">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="otc image.jpeg" class="card-img-top" alt="Product 1" width="200" height="200">
            <div class="card-body">
...
## OUTPUT:
![alt text](<web pic.png>)
![alt text](<about pic.png>)
![alt text](<product pic.png>)
![alt text](<contact pic.png>)
